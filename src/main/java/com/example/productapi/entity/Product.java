...
@Entity @Table(name="product", indexes={@Index(name="idx_product_name", columnList="product_name"), @Index(name="idx_product_created_on", columnList="created_on")})
...
public class Product {
    ...
    @Column(name="modified_on") private LocalDateTime modifiedOn;
